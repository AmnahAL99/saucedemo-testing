...
public class Action {
    ...
    public void enter_invalid_standard_user_and(String userName, String passWord) {
        objLogin.enter_wrong_uname_pswd_using_example(userName, passWord);
    }
    ...
    public void an_error_message_should_be_displayed() {
        Assert.assertTrue("Epic sadface: Password is required", objLogin.uname_pswd_not_match_msg());
        Assert.assertTrue("Epic sadface: Username is required", objLogin.uname_pswd_not_match_msg());
        Assert.assertTrue("Epic sadface: Username and password do not match any user in this service", objLogin.uname_pswd_not_match_msg());
        driver.close();
    }
